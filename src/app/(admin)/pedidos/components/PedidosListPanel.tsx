...
export function PedidosListPanel() {
  ...
  const exportToExcel = async () => {
    ...
    try {
      ...
      const headers = [
        "ID", "Data", "Nome", "Email", "Telefone", "CPF",
        "Endereco", "Numero", "Complemento", "Bairro", "Cidade", "Estado", "CEP",
        "Itens", "Total Pedido", "Frete", "Total Final",
        "Status Pagamento", "Transportadora", "Prazo Entrega",
      ];
      ...
      const rows = allPedidos.map((pedido) => {
        ...
        return [
          ...
          pedido.email, pedido.telefone, pedido.cpf,
          pedido.endereco, pedido.numero, pedido.complemento || "",
          pedido.bairro, pedido.cidade, pedido.estado, pedido.cep,
          itensResumo,
