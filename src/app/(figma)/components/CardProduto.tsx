  ...
  return (
    <div className="bg-white flex flex-col gap-4 items-start pb-4 pt-0 px-0 rounded-2xl shadow-[0px_1px_2px_0px_rgba(0,0,0,0.3),0px_1px_3px_1px_rgba(0,0,0,0.15)] w-[230px]">
      ...
      <div className="relative w-full h-[196px] max-h-[312px]">
        ...
        {ranking && (
          <div className="absolute left-[calc(50%-66px)] top-[-2px] w-8 h-10 flex flex-col items-center justify-start pb-1 pt-[5px] px-1 -translate-x-1/2">
            {/* Background vermelho com sombra */}
            <div className="absolute top-0 left-0 w-8 h-[41px]">
              <svg width="32" height="41" viewBox="0 0 32 41" fill="none">
                <path d="M0 0H32V32L16 41L0 32V0Z" fill="#C13832"/>
              </svg>
            </div>
            <div className="absolute top-px left-0 w-8 h-[39px]">
              <svg width="32" height="39" viewBox="0 0 32 39" fill="none">
                <path d="M0 0H32V31L16 39L0 31V0Z" fill="#FF0000"/>
              </svg>
            </div>
            {/* Número */}
            <div className="relative z-10 flex flex-col justify-center leading-[0]">
              <p className="font-times font-bold text-[32px] text-white text-center leading-normal">{ranking}</p>
            </div>
            {/* Linha superior vermelha */}
            <div className="absolute top-0 left-0 w-8 h-[2px] bg-[#ff7b73]" />
          </div>
        )}
