...
export function BarraFixaComprar({ produto }: BarraFixaComprarProps) {
      ...
      <div className="fixed bottom-0 z-10 w-full bg-[#fff] font-poppins">
        ...
        <div className="flex items-center gap-[20px] whitespace-nowrap px-[16px] py-[12px]">
          ...
          <div className="w-full">
            <button
              className="w-full rounded-[100px] bg-[#FF69B4] px-[20px] py-[12px] text-[16px] font-semibold text-[#fff]"
