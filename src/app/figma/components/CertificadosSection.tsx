...
function CertificadoCard({ icon, titulo, subtitulo, imagemFundo }: CertificadoCardProps) {
  return (
    <div className="relative flex items-center w-[380px] h-[64px] bg-white rounded-xl shadow-[0px_1px_2px_0px_rgba(0,0,0,0.3),0px_1px_3px_1px_rgba(0,0,0,0.15)] overflow-hidden">
      {/* Texto e Ícone */}
      <div className="flex-1 flex items-center gap-2 h-full p-4">
        ...
        <div className="flex flex-col gap-2 flex-1">
          <p className="font-cera-pro font-bold text-[20px] text-[#1d1b20] leading-none">
            {titulo}
          </p>
          <p className="font-cera-pro font-light text-[14px] text-[#1d1b20] leading-none">
            {subtitulo}
          </p>
        </div>
      </div>
